...
export function middleware(request: NextRequest) {
  ...
  `.replace(/\s{2,}/g, ' ').trim(); // Format ulang biar rapi di header
...
// Konfigurasi Matcher: Tentukan rute mana saja yang dikawal oleh Middleware ini
export const config = {
  matcher: [
    /*
     * Kunci semua rute KECUALI:
     * - api (route API biarkan jalan normal, kecuali mau dikunci juga)
